...
/// <summary>
/// Settings for the table list command.
/// </summary>
public class TableListCommandSettings : DatabaseCommandSettings
{
    [CommandOption("--filter <VALUE>")]
    [Description("Filter tables by name (^prefix, suffix$, ^exact$, or contains)")]
